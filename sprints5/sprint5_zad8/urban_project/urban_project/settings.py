"""
Настройки Django для проекта urban_project.

Создано 'django-admin startproject' с использованием Django 5.0.3.
...
WSGI_APPLICATION = 'urban_project.wsgi.application'
