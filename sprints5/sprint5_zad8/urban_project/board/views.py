...
def advertisement_list(request):
    ...
    paginator = Paginator(advertisements, 7)  # Отображаем 7 объявлений на странице

    page_number = request.GET.get('page')  # Получаем номер страницы из URL-параметров
    page_obj = paginator.get_page(page_number)  # Получаем объявления для текущей страницы
